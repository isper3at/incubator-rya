...
public interface EventStorage extends RyaObjectStorage<Event> {
     ...
     */
    public Optional<Event> get(final RyaURI subject, Collection<IndexingExpr> geoFilters, Collection<IndexingExpr> temporalFilters) throws ObjectStorageException;
