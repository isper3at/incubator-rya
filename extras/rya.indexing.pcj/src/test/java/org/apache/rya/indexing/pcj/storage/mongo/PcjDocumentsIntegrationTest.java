 ...
 */
public class PcjDocumentsIntegrationTest {
    ...
    private MongoPcjDocuments converter;
    ...
    @BeforeClass
    public static void killLoudLogs() throws Exception {
        Logger.getLogger(ClientCnxn.class).setLevel(Level.ERROR);
    }

    @Before
    public void resetTestEnvironmanet() throws Exception {
        client = MockMongoFactory.newFactory().newMongoClient();
        converter = new MongoPcjDocuments(client, "TEST");
    ...
    private RyaSailRepository setupRya() throws Exception {
        ...
        conf.set(CLOUDBASE_INSTANCE, "TEST");
