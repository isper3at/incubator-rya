...
public class MongoToMongoIT extends ITBase {
    ...
    @Before
    public void setupMongos() throws MongoException, NumberFormatException, RepositoryException, AccumuloException, AccumuloSecurityException, RyaDAOException, InferenceEngineException, IOException, SailException {
    ...
    @Test
    public void emptyMergeTest() throws AddStatementException, FetchStatementException {
        ...
        final MemoryTimeMerger merger = new MemoryTimeMerger(timeStore, childStore,
                parentMetadata, childMetadata, new VisibilityStatementMerger(), currentTime, RYA_INSTANCE);
        merger.runJob();
    ...
    public void childToParent_ChildAddTest() throws AddStatementException, FetchStatementException {
        ...
        final MemoryTimeMerger otherMerger = new MemoryTimeMerger(childStore, parentStore,
                childMetadata, parentMetadata, new VisibilityStatementMerger(), currentTime, RYA_INSTANCE);
        otherMerger.runJob();
