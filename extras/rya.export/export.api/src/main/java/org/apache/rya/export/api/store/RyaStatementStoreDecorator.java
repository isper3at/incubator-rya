...
public abstract class RyaStatementStoreDecorator implements RyaStatementStore {
    ...
    @Override
    public void updateStatement(final RyaStatement statement, final RyaStatement other) throws UpdateStatementException {
        store.updateStatement(statement, other);
    }
