...
public class AccumuloMerger implements Merger {
    ...
    public void runJob() {
        ...
        try {
            ...
            final RyaStatement childRyaStatement = nextRyaStatement(childRyaStatementIterator);
            while (childRyaStatement != null) {
                ...
                final Optional<RyaStatement> result = accumuloStatementManager.merge(Optional.of(parentRyaStatement), Optional.of(childRyaStatement));
                if (result.isPresent()) {
