...
public class QueryManagerIT {
    ...
    // Test No query change log sources, add a new one

    // Test existing query change log sources, add a new one with same rya instance
    
    // Test No query change log sources, remove one

    // Test one existing query change log sources, remove one
