...
import org.apache.rya.benchmark.query.Parameters;
...
import org.apache.rya.benchmark.query.mongo.MongoQueryBenchmark.QueryBenchmarkRun.NotEnoughResultsException;
...
public class MongoQueryBenchmark {
    ...
    public void setup() throws Exception {
        ...
        ryaConf.setAuths(rya.getAuths().getAuth().toArray(new String[]{}));
        ryaConf.set(MongoDBRdfConfiguration.MONGO_USER, confMongo.getUsername());
        ryaConf.set(MongoDBRdfConfiguration.MONGO_USER_PASSWORD, confMongo.getPassword());
        ...
        ryaConf.setCollectionName(confMongo.getCollection());
        ...
        ryaConf.set(ConfigUtils.USE_MONGO, "true");
    ...
    public static void main(final String[] args) throws Exception {
        ...
        options.include(MongoQueryBenchmark.class.getSimpleName());
        ...
        for(int i = 0; i < sparqlArray.length; i++) {
            sparqlArray[i] = sparqlArray[i].replace("\n", " ").trim();
        }
